...
- [x]  Além disso, o React Hook Form foi utilizado para lidar com a lógica de formulários, enquanto o Styled Components foi utilizado para estilizar os componentes de forma modular e reutilizável.
